        ...
        if (temp_one == "Celsius") {
            switch (temp_two) {
                case "Fahrenheit":
                    ...
                    output_temp_informer.innerText = "Temperature in Fahrenheit: " + output_temp;
                break;
                default:
                    output_temp = parseInt(input_temperature.value) + 273.15;
                    output_temp_informer.innerText = "Temperature in Kelvin: " + output_temp;
                break;
            }
        }
        if (temp_one == "Fahrenheit") {
            switch (temp_two) {
                case "Celsius":
                    ...
                    output_temp_informer.innerText = "Temperature in Celsius: " + output_temp;
                break;
                default:
